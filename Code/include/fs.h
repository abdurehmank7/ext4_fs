...
#define INODES_PER_BLOCK (BLOCK_SIZE / INODE_SIZE) // 64 bytes per inode, hence 64 inodes per block
...
#define FLAGS_PER_BLOCK (BLOCK_SIZE / sizeof(uint32_t)) //1024 number in every bitmap
 ...
 */
struct superblock // superblock: contains information about the file system.
{
...
void print_directory_block(int block_number);
